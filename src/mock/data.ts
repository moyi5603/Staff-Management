...
export const projects: Project[] = [
  {
    ...
    leaderName: '张三',
    members: [
      { employeeId: 'emp-001', name: '张三', role: '负责人', departmentName: '产品部' },
      { employeeId: 'emp-002', name: '李四', role: '核心成员', departmentName: '技术部' },
      { employeeId: 'emp-003', name: '王五', role: '一般成员', departmentName: '产品部' },
    ],
  ...
  },
  {
    ...
    leaderName: '陈丽华',
    members: [
      { employeeId: 'emp-001', name: '张三', role: '核心成员', departmentName: '产品部' },
      { employeeId: 'emp-004', name: '陈丽华', role: '负责人', departmentName: '销售部' },
    ],
  ...
  },
  {
    ...
    leaderId: 'emp-002',
    leaderName: '李四',
    members: [{ employeeId: 'emp-002', name: '李四', role: '负责人', departmentName: '技术部' }],
...
export const employees: Employee[] = [
  ...
  },
  {
    ...
    interests: ['游戏'],
    interestGroups: [],
    certificates: [{ id: 'cert-2', name: '前端开发工程师（高级）' }],
    honors: [],
    projects: [
      {
        projectId: 'proj-1',
